    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary/5 border-r border-border flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Multi-tenant task management with role-based access control.</p>
        </div>
        <div className="flex gap-3">
          {['Todo', 'In Progress', 'Done'].map((s) => (
            <div key={s} className="px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium">{s}</div>
          ))}
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-2 mb-6">
            <a
              ...
              className="flex items-center justify-center gap-3 w-full border border-border rounded-lg px-4 py-2.5 text-sm font-medium hover:bg-accent transition-colors"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-muted-foreground"><span className="bg-background px-2">or continue with email</span></div>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link to="/register" className="text-primary font-medium hover:underline">Create workspace</Link>
          </p>
        </div>
      </div>
    </div>
